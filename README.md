...
使用单例类的写法会将整个类中的所有方法全部变为类似静态方法的掉员工方式。而如果我们只希望让类中的某一方法变成静态方法的调用方式：
...
Kotlin 没有直接定义静态方法的关键字，但是提供给了一些语法特性来支持类似于静态方法的调用写法。
...
### TextView
gravity: 指定文章的对其方式，可以是 top,bottom,start, end, center, 可以用|同时指定多个值，

### Button 

默认文本全是大写，可以通过 textAllCaps = "false" 设置
id: "@+id/button"
